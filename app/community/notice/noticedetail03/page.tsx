        ...
        <div className="inner">
            ...
            <div>
                ...
                <div className="content_box">
                    <p> 
                    건설안전 평가를 강화하기 위해 붙임과 같이 「조달청 시설공사 집행기준」을 개정하고 2024.1.1. 이후 최초 입찰공고 분부터 시행함을 알려드립니다.
                    <br/> <br/>
                    ※ 문의처 <br/>
                      ...
                      <td>
                        <dl>
                          ...
                          <dd className="attachments">
                              <a href="../../../../public/file/test.zip" download="231220_조달청_시설공사_집행기준(전문).zip">231220_조달청_시설공사_집행기준(전문).zip</a>
                          </dd>
                        </dl>
                      </td>
                  </tr>
